...
public class Ssa {
    ...
    // TODO: lab7, exercise 1.
    // /////////////////////////////////////////////////////////
    // expression
    public static class Exp {
        public sealed interface T
                permits Bop, Call, Eid, GetMethod, Int, New, Phi, Print {
        }
        ...
        public static void pp(T t) {
            switch (t) {
                ...
                case Phi(List<Tuple.Two<Block.T, Id>> arguments) -> {
                    say(STR."phi(");
                    arguments.forEach((a) ->
                            say(STR."(\{Block.getLabel(a.first()).toString()}, \{a.second().toString()}), "));
                    say(")");
                }
    ...
    public static class Block {
        ...
        public static void dot(T t, Dot d) {
            switch (t) {
                case Singleton(
                        Label label,
                        List<Stm.T> phis,
        ...
        public static void dot(T func) {
            switch (func) {
                case Singleton(
                    ...
                    Dot d = new Dot(STR."\{classId.toString()}-\{functionId.toString()}");
